...
function App() {
  ...
  const handleFileChange = (e) => {
    ...
    const minProgressBeforeParse = 90; // No pasar de 90% hasta que termine el parse
    const interval = setInterval(() => {
      if (progress < minProgressBeforeParse && !isParsingDone) {
        progress += 5;
    ...
    Papa.parse(file, {
      ...
      complete: (results) => {
        isParsingDone = true;
        // Terminar la barra de progreso visual
